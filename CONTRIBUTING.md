...
Bugs from the community are tracked in [Github Issues](https://github.com/looker-open-source/bqjdbc/issues).
...
Enhancements Requests from the community are tracked in [Github Issues](https://github.com/looker-open-source/bqjdbc/issues).
...
- [ ] Make sure to open an issue as a [bug/issue](https://github.com/looker-open-source/bqjdbc/issues/new/choose) before writing your code!  That way we can discuss the change, evaluate designs, and agree on the general idea
