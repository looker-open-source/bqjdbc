...
/**
 * A small proxy class with which every request is by default minified JSON. This is to help improve
 * performance for BigQuery as for certain payloads the cost of whitespace can be quite taxing.
 */
public class MinifiedBigquery extends Bigquery {

  /** By default we minify (non-pretty) the JSON. We leave it toggleable for debugging purposes. */
  private boolean pretty;

  /**
   * The way in which we create our minified version. Create a normal builder but don't call build
   * but pass it to this constructor. Defaults the pretty printing to false.
   */
  ...
  public Jobs jobs() {
    return new Jobs() {
      ...
      @Override
      public Insert insert(String projectId, Job content, AbstractInputStreamContent mediaContent)
          throws IOException {
  ...
  public Models models() {
    return new Models() {
      ...
      @Override
      public Patch patch(String projectId, String datasetId, String modelId, Model content)
          throws IOException {
  ...
  public Routines routines() {
    return new Routines() {
      @Override
      public Delete delete(String projectId, String datasetId, String routineId)
          throws IOException {
      ...
      @Override
      public Update update(String projectId, String datasetId, String routineId, Routine content)
          throws IOException {
  ...
  public Tabledata tabledata() {
    return new Tabledata() {
      ...
      public InsertAll insertAll(
          String projectId, String datasetId, String tableId, TableDataInsertAllRequest content)
          throws IOException {
