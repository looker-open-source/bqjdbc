...
public class QueryResultTest {
	...
	Logger logger = Logger.getLogger(QueryResultTest.class);
	/**
			...
			BasicConfigurator.configure();
				...
				try {
					...
					con = DriverManager.getConnection("jdbc:BQDriver:"+
							...
							URLEncoder.encode("75052f40a510f847bca96db99253897c5c797524-privatekey.p12","UTF-8")+":"+
							URLEncoder.encode("starschema.net:clouddb","UTF-8")
							);
					logger.info("jdbc:BQDriver:"+
							URLEncoder.encode("serviceacc230262422504-8hee1pe5017iq1i48jehgnj3vj517694@developer.gserviceaccount.com","UTF-8")+":"+
							URLEncoder.encode("C:\75052f40a510f847bca96db99253897c5c797524-privatekey.p12","UTF-8")+":"+
							URLEncoder.encode("starschema.net:clouddb","UTF-8"));
				} 
				catch (Exception e){
	...
	public void QueryResultTest11() {
		final String sql = "SELECT x.corpus_date,SUM(x.word_count) FROM publicdata:samples.shakespeare x GROUP BY x.corpus_date ORDER BY x.word DESC LIMIT 5;";
		//final String description =  "A query which gets how many words Shapespeare wrote in a year (5 years displayed descending)";
		/*String[][] expectation = new String[][]
		{
		{"1612","1611","1610","1609","1608"},
